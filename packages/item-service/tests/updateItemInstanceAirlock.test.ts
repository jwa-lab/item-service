    ...
    describe("When called with an invalid message body", () => {
        ...
        it("Then throws an error when data is too big (10001 bytes or higher)", () => {
            expect(
                ...
                "Invalid data provided, please check your payload. Details: UpdateItemInstance -- Maximum payload size exceeded. Details: Got 11004 bytes but maximum is 10000 bytes."
            );
        });
    });
